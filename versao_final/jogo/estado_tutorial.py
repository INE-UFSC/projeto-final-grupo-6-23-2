...
class EstadoTutorial(Estado):
    def __init__(self, refer_jogo, configuracoes):
        ...
        self.__panel = pygame.image.load(
            "versao_final/styles/assets/telas/backgrounds/panel.png"
        ).convert_alpha()
        ...
        self.__title = pygame.image.load(
            f"versao_final/styles/assets/telas/title/tutorial-title.png"
        ).convert_alpha()
        self.__title_rect = self.__title.get_rect()
        self.__title_rect.x = 0
        self.__title_rect.y = 30

        self.__keys = pygame.image.load(
            f"versao_final/styles/assets/telas/buttons/keys.png"
        ).convert_alpha()
        self.__keys_rect = self.__keys.get_rect()
        self.__keys_rect.x = 240
        self.__keys_rect.y = 150

        self.__coins = pygame.image.load(
            f"versao_final/styles/assets/telas/buttons/coins.png"
        ).convert_alpha()
        ...
        self.__duplopulo = pygame.image.load(
            f"versao_final/styles/assets/telas/buttons/duplopulo.png"
        ).convert_alpha()
        ...
        self.__imortal = pygame.image.load(
            f"versao_final/styles/assets/telas/buttons/imortal.png"
        ).convert_alpha()
